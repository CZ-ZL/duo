...
```sh
python3 scripts/research/run_native_comparison.py --mode offline --dsh-package /path/to/cached/@deepseek-ai/dsh --output /tmp/duo-comparison-offline
python3 scripts/research/run_native_comparison.py --mode prepare-live --dsh-package /path/to/cached/@deepseek-ai/dsh --pricing /path/to/current-cny-pricing.json --output /tmp/duo-comparison-live
python3 scripts/research/run_native_comparison.py --mode execute --output /tmp/duo-comparison-live --authorization /path/to/user-approved-comparison.json
python3 scripts/research/run_native_comparison.py --mode inspect --output /tmp/duo-comparison-live
```
...
```sh
python3 scripts/research/run_native_calling.py --mode offline --dsh-package /path/to/cached/@deepseek-ai/dsh --output /tmp/duo-caller-offline
python3 scripts/research/run_native_calling.py --mode prepare-live --dsh-package /path/to/cached/@deepseek-ai/dsh --pricing /path/to/current-cny-pricing.json --output /tmp/duo-caller-live
python3 scripts/research/run_native_calling.py --mode execute --output /tmp/duo-caller-live --authorization /path/to/user-approved-caller.json
```
