# DUO 0.5.0 — current product support
...
Replaceable components: Target (duoTarget); Generator (duoGenerator); Executor (duoExecutor); Evaluator (duoEvaluators); Evidence comparison (duoComparator); Promotion (duoGate); Feedback and history order (duoFeedback). Cordis owns registration, dependency injection and disposal. No new DUO registry/runtime is required.
