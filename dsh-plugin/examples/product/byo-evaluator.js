...
export async function apply(ctx){
 await ctx.plugin(FunctionEvaluators,{evaluate:evaluateText,descriptors:descriptors(),
  implementationDigest:'byo-text-check-v1',dataDigest:'target-text-local-only-v1'})
}
